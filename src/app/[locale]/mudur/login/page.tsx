...
function LoginHeader() {
  const t = useTranslations('mudur.login')
  const navLinks = [
    { label: t('navHowItWorks'), href: '/#nasil-calisir' },
    { label: t('navFaq'), href: '/#sss' },
    { label: t('navOrderTracking'), href: '/siparis-takip' },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="pointer-events-auto flex items-center gap-6 lg:gap-8 h-12 pl-5 pr-6 rounded-full backdrop-blur-xl shadow-[0_8px_24px_-12px_rgba(0,0,0,0.12)]">
            <Link href="/" className="flex items-center gap-2 shrink-0" aria-label={t('logoAriaLabel')}>
