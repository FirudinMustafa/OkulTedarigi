            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t('colStudentParent')}</TableHead>
            ...
            <div className="space-y-4 py-4">
              <div className="p-4 bg-gray-50 rounded-lg space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-500">{t('orderNoLabel')}</span>
                  <span className="font-mono">{selectedRequest.order.orderNumber}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">{t('studentLabel')}</span>
              ...
              <div>
                <label className="text-sm font-medium text-gray-700">{t('reasonLabel')}</label>
              ...
              <div>
                <label className="text-sm font-medium text-gray-700">{t('adminNoteLabel')}</label>
                <Textarea
                  value={adminNote}
